                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="<?php echo SITEURL; ?>admin_area/category-update.php?id=<?php echo $category_id; ?>" class="update">Upadate</a>
                                        <a href="<?php echo SITEURL; ?>admin_area/category-delete.php?id=<?php echo $category_id; ?>&image_name=<?php echo $image_name; ?>" class="remove">Remove</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
