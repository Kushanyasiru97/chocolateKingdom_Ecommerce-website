                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="<?php echo SITEURL; ?>admin_area/admin-update.php?id=<?php echo $admin_id; ?>" class="update">Upadate</a>
                                        <a href="<?php echo SITEURL; ?>admin_area/admin-delete.php?id=<?php echo $admin_id; ?>&image_name=<?php echo $image_name; ?>" class="remove">Remove</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
