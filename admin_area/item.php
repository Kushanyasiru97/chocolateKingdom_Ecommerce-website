                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="<?php echo SITEURL; ?>admin_area/item-update.php?id=<?php echo $item_id; ?>" class="update">Upadate</a>
                                        <a href="<?php echo SITEURL; ?>admin_area/item-delete.php?id=<?php echo $item_id; ?>&image_name=<?php echo $image_name; ?>" class="remove">Remove</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
