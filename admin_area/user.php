                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php 
                                        if($image_name!=""){
                                            ?>
                                            <img src="images/user/<?php echo $image_name; ?>">
                                            <?php
                                        } else {
                                ...
                                <td>
                                    <div>
                                        <a href="<?php echo SITEURL; ?>admin_area/user-update.php?id=<?php echo $user_id; ?>" class="update">Upadate</a>
                                        <a href="<?php echo SITEURL; ?>admin_area/user-delete.php?id=<?php echo $user_id; ?>" class="remove">Remove</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
