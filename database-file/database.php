...
$sql = "CREATE DATABASE chocolate_shop_db";
...
$db_select = mysqli_select_db($conn, "chocolate_shop_db") or die(mysqli_error()); //Selecting Database
...
$res6 = mysqli_query($conn, $sql6) or die(mysqli_error());

if($res6 == true) {
    echo "<h3>Successfuly cart_table created!<br></h3>";
} else {
    echo "<h3>Error on creating cart_table.<br></h3> ";
}
