        ...
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Pages</h4>
                ...
                <ul><!-- ul Begin -->
                    <li><a href="user-area/Login.php">Shopping Cart</a></li>
                    <li><a href="#footer">Contact Us</a></li>
                    <li><a href="user-area/Login.php">My Account</a></li>
                </ul><!-- ul Finish -->
                ...
                <ul><!-- ul Begin -->
                    <li><a href="user-area/Login.php">Login</a></li>
                    <li><a href="user-area/signup.php">Register</a></li>
                </ul><!-- ul Finish -->
                                ...
                                if($res==TRUE){
                                    ...
                                    if($count>0){
                                        ...
                                        while($rows=mysqli_fetch_assoc($res)){
                                            ...
                                            ?>
                    <li><a href="user-area/Login.php"><?php echo $category_name; ?></a></li>
                    <?php }}} ?>
